  ...
  <div>
    <md-table v-model="searched" md-sort="name" md-sort-order="asc" md-card md-fixed-header>
      ...
      <md-table-empty-state
        ...
        <md-button class="md-primary md-raised" @click="writingNotice">Create New User</md-button>
      </md-table-empty-state>
      ...
      <md-table-row slot="md-table-row" slot-scope="{ item }" @click="detailNotice(item)">
        ...
        <md-table-cell md-label="적용앱" md-sort-by="app_key">{{ item.app_key }}</md-table-cell>
        <md-table-cell md-label="팝업여부" md-sort-by="show_yn">{{ item.show_yn }}</md-table-cell>
        <md-table-cell md-label="팝업후종료" md-sort-by="skip_yn">{{ item.skip_yn }}</md-table-cell>
    ...
    <md-button @click="writingNotice" class="md-fab md-primary">
      <md-icon>add</md-icon>
    </md-button>
  </div>
</template>
...
<script>
  ...
  export default {
    ...
    methods: {
      ...
      writingNotice() {
        this.$router.push("noticeWriting")
      },
      detailNotice(data) {
        // e.preventDefault();
